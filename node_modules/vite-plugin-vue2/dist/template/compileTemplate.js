...
const vue_template_babel_compiler_1 = __importDefault(require("vue-template-babel-compiler"));
...
function actuallyCompile(options) {
    ...
    if (transformAssetUrls) {
        const builtInModules = [
            transformAssetUrls === true
                ? (0, assetUrl_1.default)(undefined, transformAssetUrlsOptions)
                : (0, assetUrl_1.default)(transformAssetUrls, transformAssetUrlsOptions),
            (0, srcset_1.default)(transformAssetUrlsOptions),
        ];
    ...
    if (errors && errors.length) {
        ...
        let code = `var __render__ = ${toFunction(render)}\n`
            + `var __staticRenderFns__ = [${staticRenderFns.map(toFunction)}]`;
        code = `${(0, vue_template_babel_compiler_1.default)(code, finalTranspileOptions)}\n`;
