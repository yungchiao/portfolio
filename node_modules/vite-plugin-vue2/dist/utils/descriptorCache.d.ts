...
export declare function createDescriptor(source: string, filename: string, { root, isProduction, vueTemplateOptions }: ResolvedOptions): SFCDescriptor;
...
export declare function getDescriptor(filename: string, errorOnMissing?: boolean): SFCDescriptor | undefined;
