  ...
  <section id="section_works">
    <div class="container">
      <div class="row">
        ...
        <div class="row">
          <div
            class="col-sm-12 d-flex flex-wrap"
            style="
          ...
          >
            <p>
              A selection of projects demonstrating my practice across: <br />
              - Data-driven UX engineering (CaFe Dashboard, Gravity Platform)<br />
              - Creative technology & AR prototyping (ReveAR) <br />
              - Interaction design forreal-world workflows <br />
              - Visual design & product thinking
            </p>
          </div>
