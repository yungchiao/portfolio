...
import cafeSitePreview from "../assets/cafe/cafe.cfhlab.studio.png";
...
export const projects = [
	{
		...
		links: [
			{
				label: "CaFe website screentshot",
				img: cafeSitePreview,
				imgAlt: "cafe.cfhlab.studio",
			},
		],
		overview: `
    ...
    `,
		...
		learning: [
			"better ways to help users interpret model-training status",
			"lightweight visual cues that reduce cognitive load",
			"clearer explanations to increase trust in machine-learning results",
		],
		conclusive:
			"This project strengthened my interest in building tools that make data-heavy or technical workflows easier for humans to understand.",
	},
	{
		slug: "gravity",
		title: "Gravity",
      ...
      `,
		...
		learning: [
			"what motivates people to contribute to a community",
			"how to support users with different levels of digital experience",
			"ways to surface meaningful stories through better content curation",
		],
		conclusive:
			"This project helped me understand how technology can strengthen community identity and how small interaction choices can influence participation.",
	},
	{
		slug: "ar",
		title: "ReveAR",
